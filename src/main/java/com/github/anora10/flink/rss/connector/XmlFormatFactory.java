...
public class XmlFormatFactory implements DeserializationFormatFactory {
    ...
    public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
        ...
        String[] fieldNames = TableSchemaUtils.getPhysicalSchema(catalogTable.getSchema()).getFieldNames();

        // validate data types: only strings can be present in schema
        DataType[] fieldTypes = TableSchemaUtils.getPhysicalSchema(catalogTable.getSchema()).getFieldDataTypes();
